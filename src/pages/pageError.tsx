  ...
  return (
    <section className='flex flex-col items-center justify-center w-dvw h-dvh'>
      ...
      <div>
        ...
        <p>{errorMessage}</p>
        <p className='p-2 px-4 bg-dark  font-mono text-softgray w-full max-w-[700px] h-96 overflow-auto'>{errorStack}</p>
        ...
        <Button variant='outlined' className='!mt-4 !ml-2 !rounded-full' href={supportLink}>
          Тех.поддержка
        </Button>
      </div>
    </section>
