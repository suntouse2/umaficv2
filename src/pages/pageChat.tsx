...
export default function PageChat() {
  ...
  const directId = params.directId !== undefined ? Number(params.directId) : null;
  ...
  return (
    <div className='flex flex-col overflow-hidden'>
      <ChatProvider campaignId={campaignId} directId={directId}>
        ...
        <div className='block lg:hidden h-full w-full border-t-[1px] border-softgray overflow-hidden'>{directId === null ? <DirectsList /> : <ChatScreen />}</div>
      </ChatProvider>
    </div>
  );
}
